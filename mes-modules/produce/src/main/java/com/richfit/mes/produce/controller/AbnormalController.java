...
public class AbnormalController extends BaseController {
    ...
    @GetMapping("/page")
    public CommonResult<IPage<Abnormal>> pageAbnormal(String siteId, String orgId, String type, String name, String startTime, String endTime, String status, String isAndon, int page, int limitString, String branchCode, String tenantId) {
