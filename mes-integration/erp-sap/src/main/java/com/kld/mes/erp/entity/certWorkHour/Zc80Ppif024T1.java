 ...
 *       &lt;sequence&gt;
 *         &lt;element name="item" type="{urn:sap-com:document:sap:soap:functions:mc-style}Zc80ppif024S1" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Zc80Ppif024T1 {
    ...
    protected List<Zc80Ppif024S1> item;
    ...
    public List<Zc80Ppif024S1> getItem() {
        if (item == null) {
            item = new ArrayList<Zc80Ppif024S1>();
        }
        return this.item;
    }
