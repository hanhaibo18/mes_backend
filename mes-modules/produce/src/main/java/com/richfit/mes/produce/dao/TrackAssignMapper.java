...
public interface TrackAssignMapper extends BaseMapper<Assign> {
    ...
    IPage<TrackItem> getPageAssignsByStatusAndRouter(@Param("page") Page page,@Param("name") String name, @Param(Constants.WRAPPER) Wrapper<TrackItem> wrapper);
       ...
       IPage<Assign> queryPage(Page page, @Param("siteId") String siteId,@Param("trackNo") String trackNo,@Param("routerNo") String routerNo, @Param("startTime") String starttime, @Param("endTime") String endTime, @Param("state") String state, @Param("userId") String userId);
