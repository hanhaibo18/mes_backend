...
public interface TrackCheckService extends IService<TrackCheck> {
     ...
     **/
    CommonResult<IPage<TrackItem>> queryQualityPage(int page, int limit, String branchCode, int isExistQualityCheck, String isScheduleComplete, String startTime, String endTime, String trackNo, String productNo, String tenantId, Boolean isRecheck, String drawingNo, String order, String orderCol);
    ...
    CommonResult<Boolean> batchAddSchedule(BatchAddScheduleDto batchAddScheduleDto);
}
