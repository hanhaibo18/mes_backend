 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IWerks" type="{urn:sap-com:document:sap:rfc:functions}char4"/&gt;
...
@XmlRootElement(name = "Zc80Mmif015")
public class Zc80Mmif015 {

    @XmlElement(name = "IWerks", required = true)
